...
Nachdem das Installationsskript (vgl. Abschnitt \ref{ah_skript}: \nameref{ah_skript}) fehlerfrei Home Assistant Supervised installiert hat, können wir mit der Einrichtung über die Weboberfläche fortfahren. 
...
\noindent Hier sehen wir einen Anmeldebildschirm (vgl. Abb. \ref{fig:ha1}: \nameref{fig:ha1}) in welchen wir unseren Benutzeraccount mit Passwort für Home Assistant anlegen. 
...
Auf dem nächsten Bildschirm (vgl. Abb. \ref{fig:ha3}: \nameref{fig:ha3}) können wir bereits vorhandene Smart-Home-Systeme wie Google Cast und Phillips Hue integrieren. 
